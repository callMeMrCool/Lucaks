...
public class MyGenerator {
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\homework\\test");
...
//         gc.setControllerName("%sController");
        ...
        dsc.setUrl("jdbc:mysql://43.226.67.49:33306/homework?characterEncoding=utf8");
...
//        strategy.setExclude(new String[]{"t_rong_bid"}); // 排除生成的表
        ...
        // 自定义实体父类
         strategy.setSuperEntityClass("com.alan.common.entity.BaseEntity");
        // 自定义实体，公共字段
